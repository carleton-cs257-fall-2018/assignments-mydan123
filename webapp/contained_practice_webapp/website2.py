...
def get_main_page():
    global api_port
    return flask.render_template('front_page2.html', api_port=api_port)

@app.route('/country/<country_name>')
def get_country_page(country_name):
    global api_port
    return flask.render_template('country_page.html', api_port=api_port, country_name=str(country_name))

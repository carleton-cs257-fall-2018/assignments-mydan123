...
def load_from_data_folder(folder):
	...
	for file_name in file_list:
		...
		for row in reader:
			...
			if len(currnet_country_data) == 0:
				currnet_country_data.append(row[0])
			...
			if current_data_category in categories_list:
				...
				current_country_list.append(current_category_list)
						
		list_of_all_countries.append(current_country_data)
